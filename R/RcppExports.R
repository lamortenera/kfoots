...
filter <- function(cols, scores, thresh, overlap, breaks) {
    .Call('kfoots_filter', PACKAGE = 'kfoots', cols, scores, thresh, overlap, breaks)
}
...
getRealSeconds <- function() {
    .Call('kfoots_getRealSeconds', PACKAGE = 'kfoots')
}
